...
namespace InstitucionMVC.Controllers
{
    public class MatriculasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("MatriculaId,Fecha_Matricula,Estudiante_Id,Asignatura_Id")] Matricula matricula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MatriculaId,Fecha_Matricula,Estudiante_Id,Asignatura_Id")] Matricula matricula)
        {
